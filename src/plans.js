export const PLAN_CATALOG = [
  ...
  },
  {
    ...
    buildSteps: [
      ...
      { title: 'Start the second shelf level', stage: 2, image: { type: 'animation-still', animation: 'shelf-second-frame', progress: 0.92 }, animation: { type: 'shelf-second-frame' }, instructions: ['At the next shelf-height marks, install the side depth rails that connect the outer corner posts first.', 'Install the front rail sections for the same shelf level, using the side rails to keep the corner posts held at the correct depth.', 'Add the non-corner front and back posts against the front rail locations, then install the remaining side depth rails for that level.'] },
