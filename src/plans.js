export const PLAN_CATALOG = [
  ...
  },
  {
    ...
    buildSteps: [
      ...
      { title: 'Add back bracing', stage: 3, instructions: ['For wide or tall racks, square the rack and fasten the generated 1x4 diagonal braces across the back face.', 'Install the braces as an X so one brace resists racking in each direction.', 'Fasten each brace end to the back posts or top and bottom frame rails, keeping the brace clear of tote openings and runner screws.'] },
