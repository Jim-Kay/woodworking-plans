export const PLAN_CATALOG = [
  ...
  },
  {
    ...
    buildSteps: [
      { title: 'Measure a real tote and set clearances', stage: 0, instructions: ['Measure the tote length, width, and height at the widest outside dimensions, usually across the lid lip.', 'Measure the lip width separately; this controls neck clearance and how much lip bears on the runner rails.', 'Enter the measurements, row count, column count, and lid side gap before cutting anything.', 'Confirm the summary shows at least 1/4 in neck clearance and about 1 in of lip bearing on each runner.'] },
