export const PLAN_CATALOG = [
  ...
  },
  {
    ...
    buildSteps: [
      ...
      { title: 'Assemble the front and back frames', stage: 1, dimensionContext: 'post', instructions: ['Build the front frame flat on the floor with the posts standing on the doubled bottom frame rail and the top rail resting across the post tops.', 'Use the calculated width-between-posts dimension to space every post line before fastening.', 'Drive two screws at each post-to-bottom-rail and post-to-top-rail joint.', 'Build the back frame the same way, checking that matching post positions and runner-height marks line up with the front frame.'] },
