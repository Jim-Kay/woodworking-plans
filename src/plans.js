export const PLAN_CATALOG = [
  ...
  },
  {
    ...
    buildSteps: [
      ...
      { title: 'Add back bracing', stage: 3, instructions: ['For wide racks, square the rack and fasten the generated 1x4 diagonal braces across the back face.', 'Install the braces as separate rear diagonals that meet near the upper center post instead of crossing through each other.', 'Fasten each brace end directly into a back post, keeping the brace clear of tote openings and runner screws.'] },
